...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIG0by7exLK9WT"; // AccessKeyId

        $accessKeySecret = "nqFfes5a0uREtIABrF9uqRjIQid09V"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($a,$b) {
        ...
        // 必填，设置短信接收号码
        $request->setPhoneNumbers($a,$b);

        // 必填，设置签名名称，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
        $request->setSignName("西点科技");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_133135068");
...
$phone=$_POST['phone'];
$a=rand(10000,99999);
$response = SmsDemo::sendSms($phone,$a);
